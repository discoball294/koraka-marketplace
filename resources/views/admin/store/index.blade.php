...
@section('title')
    <title>Toko / Store - Koraka Marketplace</title>
@endsection
@section('plugins_css')
...
@section('content')
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <h1 class="page-title"> Toko / Store
            <small></small>
        </h1>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-shopping-cart"></i>Daftar Toko / Store
                        </div>
                        <ul class="pagination pagination-circle" style="margin-right: 10px">
                            ...
                            <li><a href="{{ $all_store->url(0) }}">«</a></li>
                            @if($all_store->lastPage() > 1)
                                @for($i = 1; $i <= $all_store->lastPage(); $i++)
                                    <li><a href="{{ $all_store->url($i) }}">{{ $i }}</a></li>
                                @endfor
                            @endif
                            <li><a href="{{ $all_store->url($all_store->lastPage()) }}">»</a></li>
                        </ul>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-advance table-hover">
                                ...
                                @foreach($all_store as $item)
                                    <tr>
                                        ...
                                        <td class="hidden-xs"> {{ $item->nama_toko }} </td>
